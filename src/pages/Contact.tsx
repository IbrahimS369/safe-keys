            ...
            <div className="mt-8">
              <div className="bg-gray-200 rounded-lg h-64 flex items-center justify-center">
                <div className="text-center text-gray-500">
                  ...
                  <p>Interactive Map</p>
                  <p className="text-sm">123 Main Street, Beverly Hills, CA</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-800">
                <strong>Quick Response Guarantee:</strong> We typically respond to all inquiries within 2 hours during business hours.
              </p>
            </div>
          </motion.div>
        </div>
